...
OUTPUT_DIR = os.path.join(ROOT_DIR, "3_processed_outputs")
TEMPLATE = os.path.join(ROOT_DIR, "web_dashboard", "templates", "dashboard_pm_template.html")
ROOT_OUT  = os.path.join(ROOT_DIR, "Predictive_Maintenance_Dashboard.html")
