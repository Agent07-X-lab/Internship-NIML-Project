...
def main():
    ...
    parser.add_argument("--input-dir", default=os.path.join(ROOT_DIR, "3_processed_outputs"), help="Directory containing constructed Graphs")
    parser.add_argument("--output-dir", default=os.path.join(ROOT_DIR, "3_processed_outputs"), help="Directory to save models and evaluations")
